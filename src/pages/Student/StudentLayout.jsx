...
//   { label: "My Classes", path: "/student/my-classes" },
//   { label: "My Marks", path: "/student/my-marks" },
...
const StudentLayout = () => {
  ...
  return (
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      {/* 🔷 Profile Header */}
      <div className="bg-teal-900 text-white rounded-3xl py-10 px-5 flex items-center justify-between shadow-lg">
        {/* Left */}
        {data && (
